...
var FormResultComponent = (function () {
    ...
    FormResultComponent.prototype.submit = function () {
        ...
        if (this.formService.editClick === true) {
            ...
            this.uploadService.newUserProject(this.formData).subscribe(function (data) {
                if (!data.success) {
                    _this.formService.showThanks = false;
                    _this.showError = true;
                    console.log(data.message); // Return error message
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.createForm = function () {
        this.form = this.formBuilder.group({
            ...
            // Company Name Input
            companyname: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].compose([
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].minLength(3),
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].maxLength(35),
                ])],
            // Job Title
            jobtitle: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].compose([
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].minLength(3),
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* Validators */].maxLength(35),
                ])],
        ...
        this.authService.getVC().subscribe(function (data) {
            ...
            data.vcs.forEach(function (arrayItem) {
                if (arrayItem.Featured === 'true') {
                    ...
                    var index = data.vcs.indexOf(arrayItem);
                    data.vcs.splice(index, 1);
                }
            });
            var data1 = reverseArray.concat(data.vcs);
            _this.vclists = data1;
    ...
    VcfilterPipe.prototype.transform = function (items, location, focus, indication, investment) {
        if (items && items.length) {
            return items.filter(function (item) {
                ...
                if ((location.length && !location.find(function (b) { return item.Location.includes(b); }))) {
                    return false;
                }
...
var AuthService = (function () {
    ...
    AuthService.prototype.getVC = function () {
        this.createAuthenticationHeaders(); // Create headers before sending to API
        return this.http.get(this.domain + '/authentication/getVcs', this.options).map(function (res) { return res.json(); });
    };
...
var UploadFileService = (function () {
    ...
    UploadFileService.prototype.newUserProject = function (data) {
        return this.http.post(this.authService.domain + '/authentication/newUserProject', data, this.options).map(function (res) { return res.json(); });
    };
